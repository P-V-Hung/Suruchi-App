    ...
    <header class="header__section">
                ...
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    <div class="header__shipping">
                        <ul class="header__shipping--wrapper d-flex">
                            ...
                            <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="{{asset('assets/img/icon/bus.png')}}" alt="bus-icon"> Track Your Order
                            </li>
                            <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="{{asset('assets/img/icon/email.png')}}" alt="email-icon"> <a class="header__shipping--text__link" href="mailto:demo@gmail.com">demo@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="d-flex align-items-center">
                            <li class="language__currency--list">
                                <a class="language__switcher text-white" href="#">
                                    <img class="language__switcher--icon__img" src="{{asset('assets/img/icon/language-icon.png')}}" alt="currency">
                                    <span>English</span>
                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="header__account header__sticky--none">
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn minicart__open--btn" href="#" data-offcanvas>
                            ...
                            <ul class="d-flex">
                                <li class="header__menu--items style2">
                                    ...
                                    <ul class="header__sub--menu">
                                        <li class="header__sub--menu__items"><a href="" class="header__sub--menu__link">Home One</a>
                                        </li>
                                        <li class="header__sub--menu__items"><a href="" class="header__sub--menu__link">Home Two</a>
                                        </li>
                                        <li class="header__sub--menu__items"><a href="" class="header__sub--menu__link">Home
                                                Three</a></li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.html">Shop Left
                                                        Sidebar</a></li>
                                                ...
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-grid.html">Shop
                                                        Grid</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-grid-list.html">Shop
                                                        Grid List</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-list.html">Shop
                                                        List</a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-details.html">Product
                                                        Details</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-video.html">Video
                                                        Product</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-details.html">Variable
                                                        Product</a></li>
                                                ...
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-gallery.html">Product
                                                        Gallery</a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="">My
                                                        Account</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="my-account-2.html">My
                                                        Account 2</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="404.html">404 Page</a>
                                                </li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="login.html">Login
                                                        Page</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="faq.html">Faq Page</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="compare.html">Compare
                                                        Pages</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="checkout.html">Checkout
                                                        page</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="checkout-2.html">Checkout
                                                        Style 2</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="checkout-3.html">Checkout
                                                        Style 3</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="checkout-4.html">Checkout
                                                        Style 4</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <li class="header__menu--items style2">
                                    ...
                                    <ul class="header__sub--menu">
                                        <li class="header__sub--menu__items"><a href="blog.html" class="header__sub--menu__link">Blog
                                                Grid</a></li>
                                        <li class="header__sub--menu__items"><a href="blog-details.html" class="header__sub--menu__link">Blog
                                                Details</a></li>
                                        <li class="header__sub--menu__items"><a href="blog-left-sidebar.html" class="header__sub--menu__link">Blog Left
                                                Sidebar</a></li>
                                        <li class="header__sub--menu__items"><a href="blog-right-sidebar.html" class="header__sub--menu__link">Blog Right
                                                Sidebar</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="header__menu--items style2">
                                    ...
                                    <ul class="header__sub--menu">
                                        <li class="header__sub--menu__items"><a href="about.html" class="header__sub--menu__link">About Us</a>
                                        </li>
                                        <li class="header__sub--menu__items"><a href="contact.html" class="header__sub--menu__link">Contact
                                                Us</a></li>
                                        <li class="header__sub--menu__items"><a href="cart.html" class="header__sub--menu__link">Cart
                                                Page</a></li>
                                        <li class="header__sub--menu__items"><a href="portfolio.html" class="header__sub--menu__link">Portfolio
                                                Page</a></li>
                                        <li class="header__sub--menu__items"><a href="wishlist.html" class="header__sub--menu__link">Wishlist
                                                Page</a></li>
                                        <li class="header__sub--menu__items"><a href="login.html" class="header__sub--menu__link">Login
                                                Page</a></li>
                                        <li class="header__sub--menu__items"><a href="404.html" class="header__sub--menu__link">Error
                                                Page</a></li>
                                    </ul>
                                </li>
                                <li class="header__menu--items style2">
        ...
        <div class="header__bottom">
            <div class="container-fluid">
                <div class="header__bottom--inner position__relative d-none d-lg-flex justify-content-between align-items-center">
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items d-none d-xl-block">
                                    <a class="header__menu--link" href="shop.html">Danh mục </a>
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="#">Pages
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                    ...
                    <p class="header__discount--text"><img class="header__discount--icon__img" src="{{asset('assets/img/icon/lamp.png')}}" alt="lamp-img">
                        Special up to 60% Off all item</p>
                </div>
            </div>
        </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.html">
                        <img src="{{asset('assets/img/logo/nav-log')}}.png" alt="Grocee Logo" width="158" height="36">
                    </a>
                    ...
                    <ul class="offcanvas__menu_ul">
                            ...
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        ...
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="shop-right-sidebar.html">Shop Right
                                                Sidebar</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="shop-grid.html">Shop Grid</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="shop-grid-list.html">Shop Grid List</a>
                                        </li>
                                ...
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-details.html">Product
                                                Details</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-video.html">Video Product</a>
                                        </li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-details.html">Variable
                                                Product</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-left-sidebar.html">Product Left
                                                Sidebar</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-gallery.html">Product
                                                Gallery</a></li>
                                    </ul>
                                </li>
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="">My Account</a></li>
                                ...
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        ...
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="checkout-2.html">Checkout Style 2</a>
                                        </li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="checkout-3.html">Checkout Style 3</a>
                                        </li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="checkout-4.html">Checkout Style 4</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li"><a href="blog-left-sidebar.html" class="offcanvas__sub_menu_item">Blog Left Sidebar</a>
                                </li>
                                <li class="offcanvas__sub_menu_li"><a href="blog-right-sidebar.html" class="offcanvas__sub_menu_item">Blog Right
                                        Sidebar</a></li>
                            </ul>
                        </li>
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li"><a href="cart.html" class="offcanvas__sub_menu_item">Cart
                                        Page</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="portfolio.html" class="offcanvas__sub_menu_item">Portfolio Page</a>
                                </li>
        ...
        <div class="offCanvas__minicart">
            <div class="minicart__header ">
                ...
                <p class="minicart__header--desc">Sản phẩm quần áo và thời trang còn hạn chế</p>
            </div>
                    ...
                    @foreach($carts as $cart)
                        <div class="minicart__product--items d-flex">
                            <div class="minicart__thumb">
                                <a href="{{route('product.detail',[$cart->conditions['slug'],$cart->conditions['product_id']])}}"><img src="{{asset('assets/img/product/product1.png')}}" alt="prduct-img"></a>
                            </div>
                            <div class="minicart__text">
                                <h3 class="minicart__subtitle h4"><a href="{{route('product.detail',[$cart->conditions['slug'],$cart->conditions['product_id']])}}">{{$cart->name}}</a></h3>
                                <span class="color__variant"><b>Màu sắc:</b> {{$cart->attributes['color']}}</span>
                                <span class="color__variant"><b>Kích cỡ:</b> {{$cart->attributes['size']}}</span>
                                <div class="minicart__price">
                                    <span class="current__price">{{number_format($cart->price - ($cart->conditions['price_seal'] / 100 * $cart->price))}}</span>
                                    <span class="old__price">{{number_format($cart->price)}}</span>
                                </div>
                                <div class="minicart__text--footer d-flex align-items-center">
                                    <div class="quantity__box minicart__quantity">
                                        <button type="button" class="quantity__value decrease mini" aria-label="quantity value" value="Decrease Value">-
                                        </button>
                                        <label>
                                            <input type="number" data-id="{{$cart->id}}" class="quantity__number count" readonly value="{{$cart->quantity}}" data-counter />
                                        </label>
                                        <button type="button" class="quantity__value increase mini" value="Increase Value">+</button>
                                    </div>
                                    <button data-id="{{$cart->id}}" class="minicart__product--remove">Xóa</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="minicart__button d-flex justify-content-center">
                <a class="primary__btn minicart__button--link" href="{{route('cart.show')}}">Giỏ hàng</a>
                <a class="primary__btn minicart__button--link" href="checkout.html">Thanh toán</a>
            </div>
        </div>
...
{{--    </div>--}}
    ...
    @yield('script')
    <script>
        $(document).on('click','.quantity__value.decrease.mini',function(){
            let input = $(this).closest('.quantity__box').find('.quantity__number.count');
            let id = input.data('id');
            let value = input.val();
            updateCountCart(id,value,'down',input);
        });
        $(document).on('click','.quantity__value.increase.mini',function(){
            let input = $(this).closest('.quantity__box').find('.quantity__number.count');
            let id = input.data('id');
            let value = input.val();
            updateCountCart(id,value,'up',input);
        });
        $(document).on('click','.minicart__product--remove',function(){
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        removeCartId(id,$(this));
                    }
                });
        });
        function updateCountCart(id, value, phepTinh,input){
            let span = input.closest('.cart__table--body__items').find('.cart__price.end');
            $.ajax({
                url: "{{route('cart.update',['_id_'])}}".replace('_id_',id),
                method: 'PUT',
                data: {
                    value,
                    phepTinh,
                ...
                success: function (response){
                    if(response.code == 200){
                        ...
                        // span.text(Math.floor(count*price).toLocaleString('en-US'));
                    }
                },
        ...
        function removeCartId(id,input){
            $.ajax({
                ...
                success: function (response){
                    ...
                    input.closest('.minicart__product--items').remove();
                },
                error: function(log){
                    console.log(log);
                }
