                                    ...
                                    <div class="row row-cols-1">
                                        <div class="col">
                                            <div class="slider__content">
                                                <p class="slider__content--desc desc1 text__secondary2 mb-15"> Big Offer 50% off</p>
                                                <h2 class="slider__content--maintitle h1">New Collection <br>
                                                    Summer Sale</h2>
                                                <p class="slider__content--desc desc2 d-sm-2-none mb-40">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do <br> eiusmod tempor incididunt ut labore et dolore magna</p>
                                                <a class="bg__secondary2 slider__btn primary__btn" href="shop.html">Show Collection
        ...
        <section class="product__section section--padding color-scheme-2 pt-0">
            <div class="container-fluid">
                <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n30">
                    <div class="col mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail width-100 " href="shop.html"><img class="banner__items--thumbnail__img width-100" src="assets/img/banner/banner14.png" alt="banner-img">
                    ...
                    <div class="col mb-30">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail md-width-100" href="shop.html"><img class="banner__items--thumbnail__img md-width-100" src="assets/img/banner/banner15.png" alt="banner-img">
                                <div class="banner__items--content__style3">
                                    <span class="banner__items--content__style3--subtitle text-white">Wmen's Collection</span>
                                    <h2 class="banner__items--content__style3--title text-white h3"> Min.40-70% Off</h2>
                                </div>
                        ...
                        <div class="product__grid--wrapper">
                            ...
                            <div class="product__grid--inner">
                                <div class="product__items product__items--grid d-flex align-items-center">
                                    <div class="product__items--grid__thumbnail position__relative">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="assets/img/product/small-product2.png" alt="product-img">
                                            <img class="product__items--img product__secondary--img" src="assets/img/product/small-product1.png" alt="product-img">
                                        </a>
                                    </div>
                                    <div class="product__items--grid__content">
                                ...
                                <div class="product__items product__items--grid d-flex align-items-center">
                                    <div class="product__items--grid__thumbnail position__relative">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="assets/img/product/small-product4.png" alt="product-img">
                                            <img class="product__items--img product__secondary--img" src="assets/img/product/small-product3.png" alt="product-img">
                                        </a>
                                    </div>
                                    <div class="product__items--grid__content">
                                ...
                                <div class="product__items product__items--grid d-flex align-items-center">
                                    <div class="product__items--grid__thumbnail position__relative">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="assets/img/product/small-product6.png" alt="product-img">
                                            <img class="product__items--img product__secondary--img" src="assets/img/product/small-product5.png" alt="product-img">
                                        </a>
                                    </div>
                                    <div class="product__items--grid__content">
                    ...
                    <div class="col">
                        <div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="assets/img/logo/brand-logo1.png" alt="brand logo img">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="assets/img/logo/brand-logo2.png" alt="brand logo img">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="assets/img/logo/brand-logo3.png" alt="brand logo img">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="assets/img/logo/brand-logo4.png" alt="brand logo img">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="assets/img/logo/brand-logo5.png" alt="brand logo img">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="shop__card--banner position__relative d-flex">
                                <div class="shop__card--banner__thumbnail one">
                                    <a class="display-block" href="shop.html"><img class="shop__card--banner__thumbnail--img display-block" src="assets/img/banner/banner16.png" alt="shop-card-banner"></a>
                                </div>
                                <div class="shop__card--banner__thumbnail two">
                                    <a class="display-block" href="shop.html"><img class="shop__card--banner__thumbnail--img display-block" src="assets/img/banner/banner17.png" alt="shop-card-banner"></a>
                                </div>
                ...
                <div class="testimonial__bg--inner testimonial__activation--column1 swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial__items--style2 testimonial__items text-center">
                                <div class="testimonial__items--style2__thumbnail mb-10">
                                    <img class="testimonial__items--style2__thumbnail--img border-radius-50" src="assets/img/other/testimonial-thumb1.png" alt="testimonial-img">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items--style2 testimonial__items text-center">
                                <div class="testimonial__items--style2__thumbnail mb-10">
                                    <img class="testimonial__items--style2__thumbnail--img border-radius-50" src="assets/img/other/testimonial-thumb2.png" alt="testimonial-img">
                                </div>
                                <div class="testimonial__items--content">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items--style2 testimonial__items text-center">
                                <div class="testimonial__items--style2__thumbnail mb-10">
                                    <img class="testimonial__items--style2__thumbnail--img border-radius-50" src="assets/img/other/testimonial-thumb3.png" alt="testimonial-img">
                                </div>
                                <div class="testimonial__items--content">
                                    <h2 class="testimonial__items--title text-white h3">Nike Mardson</h2>
                                    <span class="testimonial__items--subtitle text-white">fashion</span>
